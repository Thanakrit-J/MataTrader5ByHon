...
# ===== CONFIG =====
SYMBOL, TIMEFRAME = "EURUSD", mt5.TIMEFRAME_M15
LOCAL_TIMEZONE = pytz.timezone("Asia/Bangkok")
RISK_PER_TRADE, TRAILING_STOP_POINTS, TAKE_PROFIT_MULTIPLIER, SL_ATR_MULTIPLIER = 0.25, 150, 2.0, 1.5
ORDER_PROFIT_MIN, ORDER_PROFIT_MAX, DAILY_PROFIT_TARGET, DAILY_LOSS_LIMIT = 1.0, 2.0, 5.0, -5.0
FAST_EMA, SLOW_EMA, RSI_PERIOD, ATR_PERIOD = 10, 20, 14, 14
SCORE_THRESHOLD, MAX_SPREAD_POINTS, MAGIC = 3, 15, 20250101
...
class AIBot:
    ...
    def track_closed_trades(self):
        ...
        for d in deals:
            ...
            if d.profit >= 0:
                ...
                self.recent_losses.append({"type": "BUY" if d.type == mt5.ORDER_TYPE_BUY else "SELL"})
    ...
    def place_trade(self, signal: str, df: pd.DataFrame):
        ...
        if r.retcode == mt5.TRADE_RETCODE_DONE: self.daily_trades += 1
